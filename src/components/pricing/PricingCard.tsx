    ...
    >
      ...
      >
        <CardHeader className="space-y-4 pb-6">
          ...
          <div className="h-6">
            {highlighted && (
              <Badge className="bg-blue-500 text-white border-none text-xs font-medium">
                Most Popular
              </Badge>
            )}
          </div>
        ...
        <CardContent className="pb-6">
          {/* Features list with fixed minimum height */}
        ...
        <CardFooter className="pt-6 mt-auto">
          ...
          >
            <Button
              className={`w-full py-6 text-base font-semibold relative overflow-hidden group transition-all duration-200 ${
